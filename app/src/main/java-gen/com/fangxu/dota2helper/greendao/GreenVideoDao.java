...
public class GreenVideoDao extends AbstractDao<GreenVideo, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Videolistjson = new Property(1, String.class, "videolistjson", false, "VIDEOLISTJSON");
        public final static Property Videotype = new Property(2, String.class, "videotype", false, "VIDEOTYPE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GREEN_VIDEO\" (" + //
                ...
                "\"VIDEOLISTJSON\" TEXT," + // 1: videolistjson
                "\"VIDEOTYPE\" TEXT);"); // 2: videotype
    }
    ...
    protected void bindValues(SQLiteStatement stmt, GreenVideo entity) {
        ...
        String videolistjson = entity.getVideolistjson();
        if (videolistjson != null) {
            stmt.bindString(2, videolistjson);
        }
 
        String videotype = entity.getVideotype();
        if (videotype != null) {
            stmt.bindString(3, videotype);
        }
    }
    ...
    public GreenVideo readEntity(Cursor cursor, int offset) {
        GreenVideo entity = new GreenVideo( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // videolistjson
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // videotype
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, GreenVideo entity, int offset) {
        ...
        entity.setVideolistjson(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setVideotype(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
