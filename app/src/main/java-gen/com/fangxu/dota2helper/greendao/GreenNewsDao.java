...
public class GreenNewsDao extends AbstractDao<GreenNews, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Newslistjson = new Property(1, String.class, "newslistjson", false, "NEWSLISTJSON");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GREEN_NEWS\" (" + //
                ...
                "\"NEWSLISTJSON\" TEXT);"); // 1: newslistjson
    }
    ...
    protected void bindValues(SQLiteStatement stmt, GreenNews entity) {
        ...
        String newslistjson = entity.getNewslistjson();
        if (newslistjson != null) {
            stmt.bindString(2, newslistjson);
        }
    }
    ...
    public GreenNews readEntity(Cursor cursor, int offset) {
        GreenNews entity = new GreenNews( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // newslistjson
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, GreenNews entity, int offset) {
        ...
        entity.setNewslistjson(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
