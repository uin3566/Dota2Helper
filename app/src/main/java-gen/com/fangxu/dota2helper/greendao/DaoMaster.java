...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        GreenStrategyDao.createTable(db, ifNotExists);
        GreenUpdateDao.createTable(db, ifNotExists);
        GreenVideoDao.createTable(db, ifNotExists);
        GreenWatchedVideoDao.createTable(db, ifNotExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(GreenStrategyDao.class);
        registerDaoClass(GreenUpdateDao.class);
        registerDaoClass(GreenVideoDao.class);
        registerDaoClass(GreenWatchedVideoDao.class);
    }
